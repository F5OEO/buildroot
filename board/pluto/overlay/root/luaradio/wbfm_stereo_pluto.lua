...
local source = radio.SoapySDRSource("driver=plutosdr",frequency + tune_offset, 1102500, {rf_gain = 81})
...
-- Sink
local sink = os.getenv('DISPLAY') and radio.PulseAudioSink(2) or radio.WAVFileSink('/www/audio.wav', 2)
